...
const ScrollToTopButton = () => {
  ...
  const [scrollProgress, setScrollProgress] = useState(0); //fill the circle as per progress
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full overflow-hidden bg-white border border-red-500 flex items-center justify-center transition-all duration-300 ease-in-out ${
