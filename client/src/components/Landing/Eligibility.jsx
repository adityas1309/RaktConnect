...
const Eligibility = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-6xl font-extrabold text-center mb-3 p-6" style={{ color: "var(--accent)" }}>
          Blood Donation Eligibility Test
        </h1>
        <p className="text-center max-w-3xl mx-auto text-m font-medium mb-10 pb-5" style={{ color: "var(--text-muted)" }}>
          Donating blood is a simple, safe, and life-saving act, but not everyone is eligible at all times. To ensure both your safety and the safety of the patient receiving your blood, take our Donor Eligibility Test for a quick self-assessment.
        </p>

        <div className="flex flex-col md:flex-row gap-8 items-start max-w-6xl mx-auto">
          <div className="w-full md:w-1/2">
            <div className="p-6 space-y-4 shadow-xl rounded-lg" style={{ background: "var(--bg-surface)", color: "var(--text-main)" }}>
              <div className="space-y-1">
                <label className="block font-medium">Age</label>
                <input
                  className="w-full border p-2 rounded"
                  style={{ background: "var(--bg-main)", color: "var(--text-main)", borderColor: "rgba(200,200,200,0.13)" }}
                  type="number"
                  name="age"
                  value={formData.age}
              ...
              {eligibility && (
                <div
                  ...
                  style={{ background: "var(--bg-main)", color: eligibility.startsWith("Eligible") ? "var(--accent)" : "var(--text-muted)" }}
                >
                  {eligibility}
                </div>
              )}
