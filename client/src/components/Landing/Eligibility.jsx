...
const Eligibility = () => {
  ...
  const checkEligibility = () => {
    ...
    const monthsSinceLastDonation = differenceInMonths(
      new Date(),
      lastDonationDate
    );
    ...
    if (age < 18 || age > 65) {
      ...
      setEligibility(
        "Not eligible: Minimum weight should be more than 50 kg."
      );
    } else if (
      ...
      setEligibility(
        "Not eligible: Please specify your chronic disease."
      );
    } else if (formData.chronicDisease === "Yes") {
      setEligibility(
        "Not eligible: You have a chronic disease."
      );
    } else if (formData.recentProcedure === "Yes") {
      setEligibility(
        "Not eligible: Wait 6 months after tattoo/piercing/surgery."
      );
    } else if (formData.feelingHealthy === "No") {
      setEligibility(
        "Not eligible: You must be in good health to donate."
      );
    } else if (monthsSinceLastDonation < 3) {
      setEligibility(
        "Not eligible: You must wait at least 3 months between donations."
      );
    } else {
      setEligibility(
        "Eligible: You meet the requirements to donate blood."
      );
    }
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          Donating blood is a simple, safe, and life-saving act, but not everyone
          is eligible at all times. To ensure both your safety and the safety of
          the patient receiving your blood, take our Donor Eligibility Test for a
